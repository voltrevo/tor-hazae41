...
test('Read', async () => {
  ...
  assert(
    hexToTriplet('02 12 03 D4 15 31 8E 2C 57 1D 29  05 FC 3E 05 27 68 9D 0D 09')
  ...
  assert(
    hexToTriplet('02 05 80 00 00 00 01').value === BigInt('-549755813887')
  );
});
...
test('Read then write', async () => {
  ...
  assert(
    checkReadWrite(
      '02 12 03 D4 15 31 8E 2C 57 1D 29  05 FC 3E 05 27 68 9D 0D 09'
    )
  );

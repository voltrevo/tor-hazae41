...
test('Base32.toString', async () => {
  // Test basic encoding
  const data = new Uint8Array([0x8b, 0x1a, 0x9b, 0x5b, 0xcd]);
...
test('Base32.fromString', async () => {
  // Test basic decoding
  const encoded = Base32.toString(
    new Uint8Array([0x8b, 0x1a, 0x9b, 0x5b, 0xcd])
  );
...
test('Base32 round-trip', async () => {
  ...
  const testCases = [
    ...
    new Uint8Array([0x8b, 0x1a, 0x9b, 0x5b, 0xcd, 0xef, 0x01, 0x23]),
  ];
...
test('Base32 known values', async () => {
  ...
  const testVectors = [
    { decoded: new Uint8Array([]), encoded: '' },
    { decoded: new Uint8Array([0x66]), encoded: 'my' },
    { decoded: new Uint8Array([0x66, 0x6f]), encoded: 'mzxq' },
    { decoded: new Uint8Array([0x66, 0x6f, 0x6f]), encoded: 'mzxw6' },
    { decoded: new Uint8Array([0x66, 0x6f, 0x6f, 0x62]), encoded: 'mzxw6yq' },
    {
      decoded: new Uint8Array([0x66, 0x6f, 0x6f, 0x62, 0x61]),
      encoded: 'mzxw6ytb',
    },
    {
      decoded: new Uint8Array([0x66, 0x6f, 0x6f, 0x62, 0x61, 0x72]),
      encoded: 'mzxw6ytboi',
    },
  ];
